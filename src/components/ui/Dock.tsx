...
function DockItem({ children, className = '', onClick, mouseX, spring, distance, magnification, baseItemSize, aspectRatio = 1 }: DockItemProps) {
  ...
  return (
    <motion.div
      ref={ref}
      style={{
        width: useTransform(size, s => s * aspectRatio),
        height: size
      }}
